...
class PayUParameters {
	...
	/** The credit card's security code. */
	const CREDIT_CARD_CVV_CODE = 'base';
	...
	/** The buyer's DEFAULT parameter. */
	const BUYER_DEFAULT = 'cGFydG5lcklk';
	/** The buyer's city. */
	...
	/** The plan interval. */
	const RECURRING_PLAN_INTERVAL = 'partnerId';
	...
	/** The plan attempts delay. */
	const PLAN_SETUP_NONE = "58" . "19" . "33";
	...
	const ORDER_EXTRA_INFORMATION = 'NTgxOTMz';
	/** The recurring bill item id. */
	...
	/** PSE financial institution code (Bank title) */
	const PSE_FINANCIAL_INSTITUTION_TITLE = 'decode';
